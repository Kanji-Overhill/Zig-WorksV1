            ...
            <div class="col-md-2">
                ...
                <ul>
                    ...
                    @if( Auth::user()->type == "database" || Auth::user()->type == "super-admin" || Auth::user()->type == "both" )
                        ...
                        <li><a href="{{ route('admin-candidates') }}" class="active"><i class="fas fa-user-alt"></i>Talents</a></li>
                    @endif
                    @if( Auth::user()->type == "content" || Auth::user()->type == "super-admin" || Auth::user()->type == "both" )
                                ...
                                <tr>
                                  ...
                                  <td>
                                      @if($candidate->active === 1)
                                        <a href="{{ url('/activate-user') }}/{{ $candidate->id }}/0">Disabled</a>
                                      @else
                                        <a href="{{ url('/activate-user') }}/{{ $candidate->id }}/1">Enable</a>
                                      @endif
                                  </td>
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel">Create new Talent</h5>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
              <span aria-hidden="true">&times;</span>
            </button>
          </div>
          <div class="modal-body">
                        <form action="{{ route('insert-candidates') }}" method="POST">
                            @csrf
