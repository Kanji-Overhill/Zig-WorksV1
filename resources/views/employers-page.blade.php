        ...
        <div class="row h-100">
            <div class="col-md-2">
                ...
                <ul>
                    ...
                    @endif
                    @if( Auth::user()->type == "content" || Auth::user()->type == "super-admin" || Auth::user()->type == "both" )
                        <li><a href="{{ route('employers_page') }}" class="active"><i class="fas fa-home"></i>Employers Page</a></li>
                    @endif
            ...
            <div class="offset-md-2 col-md-6">
                <h1 class="text-center mt-4 mb-4 pb-4">Employers Page</h1>
                <form action="{{ route('saveEmployers') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="mb-4">
                        <input type="text" name="banner_link" class="form-control mb-4" value="{{ $employers->banner_link }}">
                    </div>
                    <div class="border-bottom mb-4">
                        <div class="form-group mt-4">
                            <label for="banner_image"><img src="{{ url('images/') }}/{{ $employers->banner_image }}" width="70" alt=""></label>
                            <input type="file" name="banner_image" id="banner_image" class="form-control-file">
                        </div>    
                    </div>
                    <div class="border-bottom mb-4">
                        <input type="text" name="title_1" class="form-control mb-4" value="{{ $employers->title_1 }}">
                    </div>
                    <div class="border-bottom mb-4">
                        <input type="text" name="title_2" class="form-control mb-4" value="{{ $employers->title_2 }}">
                        <textarea  name="text_2" class="ckeditor form-control mb-4">{{ $employers->text_2 }}</textarea>
                    </div>
                    <div class="border-bottom mb-4">
                        <input type="text" name="title_3" class="form-control mb-4" value="{{ $employers->title_3 }}">
                        <textarea  name="text_3" class="ckeditor form-control mb-4">{{ $employers->text_3 }}</textarea>
                        <div class="form-group mt-4">
                            <label for="image_3"><img src="{{ url('images/') }}/{{ $employers->image_3 }}" width="70" alt=""></label>
                            <input type="file" name="image_3" id="image_3" class="form-control-file">
                        </div>    
                    </div>
                    <div class="border-bottom mb-4">
                        <input type="text" name="title_4" class="form-control mb-4" value="{{ $employers->title_4 }}">
                        <textarea  name="text_4" class="ckeditor form-control mb-4">{{ $employers->text_4 }}</textarea>
                    </div>
                    <div class="row">
                        <div class="col-12">
                        ...
                        <div class="col-md-4">
                            <div class="form-group mt-4">
                                <input type="text" name="slider_1_video" class="form-control mb-4" value="{{ $employers->slider_1_video }}">
                                <label for="slider_1_image"><img src="{{ url('images/') }}/{{ $employers->slider_1_image }}" width="70" alt=""></label>
                                <input type="file" name="slider_1_image" id="slider_1_image" class="form-control-file">
                            </div>    
                        </div>
                        <div class="col-md-4">
                            <div class="form-group mt-4">
                                <input type="text" name="slider_2_video" class="form-control mb-4" value="{{ $employers->slider_2_video }}">
                                <label for="slider_2_image"><img src="{{ url('images/') }}/{{ $employers->slider_2_image }}" width="70" alt=""></label>
                                <input type="file" name="slider_2_image" id="slider_2_image" class="form-control-file">
                            </div>    
                        </div>
                        <div class="col-md-4">
                            <div class="form-group mt-4">
                                <input type="text" name="slider_3_video" class="form-control mb-4" value="{{ $employers->slider_3_video }}">
                                <label for="slider_3_image"><img src="{{ url('images/') }}/{{ $employers->slider_3_image }}" width="70" alt=""></label>
